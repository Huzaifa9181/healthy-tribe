...
@section('content')
@section('title', $title)
<link rel="stylesheet" href="{{ url('public/admin/dist/css/chat.css') }}">
                    ...
                    <ul class="list-unstyled chat-list mt-2 mb-0">
                        @if(count($chats) > 0)
                            @foreach ($chats as $val)
                                <li class="clearfix">
                                    <img src="{{ asset('public/') .'/'. $val['user']->image ?? 'https://bootdey.com/img/Content/avatar/avatar1.png' }}" alt="avatar">
                                    <div class="about">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="chat-about">
                                    <h6 class="m-b-0 mt-2">Aiden Chavez</h6>
