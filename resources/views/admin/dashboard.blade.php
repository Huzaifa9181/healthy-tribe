                  ...
                  <div class="card-body">
                    ...
                    <div class="direct-chat-messages">
                      ...
                      <div class="direct-chat-msg">
                        ...
                        <!-- /.direct-chat-infos -->
                        <img class="direct-chat-img" src="{{url('public/admin/dist/img/user1-128x128.jpg')}}" alt="message user image">
                        <!-- /.direct-chat-img -->
                      ...
                      <div class="direct-chat-msg right">
                        ...
                        <!-- /.direct-chat-infos -->
                        <img class="direct-chat-img" src="{{url('public/admin/dist/img/user3-128x128.jpg')}}" alt="message user image">
                        <!-- /.direct-chat-img -->
                        <div class="direct-chat-text">
                    ...
                    <div class="direct-chat-contacts">
                      <ul class="contacts-list">
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="{{url('public/admin/dist/img/user1-128x128.jpg')}}" alt="User Avatar">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="{{url('public/admin/dist/img/user7-128x128.jpg')}}" alt="User Avatar">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="{{url('public/admin/dist/img/user3-128x128.jpg')}}" alt="User Avatar">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="{{url('public/admin/dist/img/user5-128x128.jpg')}}" alt="User Avatar">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="{{url('public/admin/dist/img/user6-128x128.jpg')}}" alt="User Avatar">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="{{url('public/admin/dist/img/user8-128x128.jpg')}}" alt="User Avatar">
                ...
                <div class="card">
                  ...
                  <div class="card-body p-0">
                    <ul class="users-list clearfix">
                      <li>
                        <img src="{{url('public/admin/dist/img/user1-128x128.jpg')}}" alt="User Image">
                        <a class="users-list-name" href="#">Alexander Pierce</a>
                        <span class="users-list-date">Today</span>
                      </li>
                      <li>
                        <img src="{{url('public/admin/dist/img/user8-128x128.jpg')}}" alt="User Image">
                        <a class="users-list-name" href="#">Norman</a>
                        <span class="users-list-date">Yesterday</span>
                      </li>
                      <li>
                        <img src="{{url('public/admin/dist/img/user7-128x128.jpg')}}" alt="User Image">
                        <a class="users-list-name" href="#">Jane</a>
                        <span class="users-list-date">12 Jan</span>
                      </li>
                      <li>
                        <img src="{{url('public/admin/dist/img/user6-128x128.jpg')}}" alt="User Image">
                        <a class="users-list-name" href="#">John</a>
                        <span class="users-list-date">12 Jan</span>
                      </li>
                      <li>
                        <img src="{{url('public/admin/dist/img/user2-160x160.jpg')}}" alt="User Image">
                        <a class="users-list-name" href="#">Alexander</a>
                        <span class="users-list-date">13 Jan</span>
                      </li>
                      <li>
                        <img src="{{url('public/admin/dist/img/user5-128x128.jpg')}}" alt="User Image">
                        <a class="users-list-name" href="#">Sarah</a>
                        <span class="users-list-date">14 Jan</span>
                      </li>
                      <li>
                        <img src="{{url('public/admin/dist/img/user4-128x128.jpg')}}" alt="User Image">
                        <a class="users-list-name" href="#">Nora</a>
                        <span class="users-list-date">15 Jan</span>
                      </li>
                      <li>
                        <img src="{{url('public/admin/dist/img/user3-128x128.jpg')}}" alt="User Image">
